...
PRIVATE_IP_PREFIX = '10.0.2.1'  # TODO-SETUP: change to match subnet preferenses
TYPICAL_TX_SIZE_BYTES = 245  # typical size of a transaction in block
TYPICAL_UTXO_SIZE_BYTES = 77  # typical size of a utxo entry in utxo set
BYTES_IN_MB = 1000000
